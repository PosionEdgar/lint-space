...
describe('Validate TS configs', () => {
  it('Validate pe-eslint-config/typescript', async () => {
  ...
  it('Validate pe-eslint-config/typescript/vue', async () => {
  ...
  it('Validate pe-eslint-config/essential/typescript', async () => {
  ...
  it('Validate pe-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate pe-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate pe-eslint-config/typescript/node', async () => {
