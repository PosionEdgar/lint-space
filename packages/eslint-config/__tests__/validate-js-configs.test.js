...
describe('Validate JS configs', () => {
  it('Validate pe-eslint-config', async () => {
  ...
  it('Validate pe-eslint-config/es5', async () => {
  ...
  it('Validate pe-eslint-config/vue', async () => {
  ...
  it('Validate pe-eslint-config/essential', async () => {
  ...
  it('Validate pe-eslint-config/essential/es5', async () => {
  ...
  it('Validate pe-eslint-config/essential/react', async () => {
  ...
  it('Validate pe-eslint-config/essential/vue', async () => {
  ...
  it('Validate pe-eslint-config/node', async () => {
